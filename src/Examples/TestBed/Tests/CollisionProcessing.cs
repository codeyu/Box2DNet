...
namespace TestBed
{
	...
	{
        private Fixture _fixturePolygon;
		...
		public CollisionProcessing()
		{
			// Ground body
			{
                ...
                _fixturePolygon = ground.CreateFixture(sd);
			}
			...
			//triangleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			triangleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), 35f);
			...
			//triangleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			triangleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), 30f);
			...
			//boxBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			boxBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), 25f);
			...
			//boxBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			boxBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), 15f);
			...
			//circleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			circleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), 10f);
			...
			//circleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), Box2DNet.Common.Math.Random(yLo, yHi));
			circleBodyDef.Position.Set(Box2DNet.Common.Math.Random(xLo, xHi), 5f);
		...
		public override void Step(Settings settings)
		{
			...
			for (int i = 0; i < _pointCount; ++i)
			{
                ...
                Body body1 = _fixturePolygon.Body;
                Body body2 = _fixturePolygon.Body;
